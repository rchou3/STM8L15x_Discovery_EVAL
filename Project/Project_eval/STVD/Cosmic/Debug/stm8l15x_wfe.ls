  ...
  43                     ; 45 void WFE_DeInit(void)
  43                     ; 46 {
  45                     	switch	.text
  46  0000               _WFE_DeInit:
  50                     ; 47   WFE->CR1 = WFE_CRX_RESET_VALUE;
  52  0000 725f50a6      	clr	20646
  53                     ; 48   WFE->CR2 = WFE_CRX_RESET_VALUE;
  55  0004 725f50a7      	clr	20647
  56                     ; 49   WFE->CR3 = WFE_CRX_RESET_VALUE;
  58  0008 725f50a8      	clr	20648
  59                     ; 50   WFE->CR4 = WFE_CRX_RESET_VALUE;
  61  000c 725f50a9      	clr	20649
  62                     ; 51 }
  65  0010 81            	ret
 389                     ; 61 void WFE_WakeUpSourceEventCmd(WFE_Source_TypeDef WFE_Source, FunctionalState NewState)
 389                     ; 62 {
 390                     	switch	.text
 ...
 398                     ; 63   uint8_t register_index = 0;
 400                     ; 65   assert_param(IS_WFE_SOURCE(WFE_Source));
 402                     ; 66   assert_param(IS_FUNCTIONAL_STATE(NewState));
 404                     ; 69   register_index = (uint8_t)((uint16_t)WFE_Source >> 0x08);
 406  0013 9e            	ld	a,xh
 407  0014 6b01          	ld	(OFST+0,sp),a
 409                     ; 71   if (NewState != DISABLE)
 411  0016 0d06          	tnz	(OFST+5,sp)
 412  0018 273c          	jreq	L502
 413                     ; 73     switch (register_index)
 ...
 427  002a               L12:
 428                     ; 75       case 1:
 428                     ; 76         WFE->CR1 |= (uint8_t)WFE_Source;
 ...
 436  0034               L32:
 437                     ; 79       case 2:
 437                     ; 80         WFE->CR2 |= (uint8_t)WFE_Source;
 ...
 445  003e               L52:
 446                     ; 83       case 3:
 446                     ; 84         WFE->CR3 |= (uint8_t)WFE_Source;
 ...
 454  0048               L72:
 455                     ; 87       case 4:
 455                     ; 88         WFE->CR4 |= (uint8_t)WFE_Source;
 ...
 485  0066               L33:
 486                     ; 99       case 1:
 486                     ; 100         WFE->CR1 &= (uint8_t)(~(uint8_t)WFE_Source);
 ...
 499  0072               L53:
 500                     ; 103       case 2:
 500                     ; 104         WFE->CR2 &= (uint8_t)(~ (uint8_t)WFE_Source);
 ...
 509  007d               L73:
 510                     ; 107       case 3:
 510                     ; 108         WFE->CR3 &= (uint8_t)(~(uint8_t)WFE_Source);
 ...
 519  0088               L14:
 520                     ; 111       case 4:
 520                     ; 112         WFE->CR4 &= (uint8_t)(~(uint8_t)WFE_Source);
 ...
 581                     ; 127 FunctionalState WFE_GetWakeUpSourceEventStatus(WFE_Source_TypeDef WFE_Source)
 581                     ; 128 {
 582                     	switch	.text
 ...
 590                     ; 129   FunctionalState status = DISABLE;
 592  0099 0f01          	clr	(OFST+0,sp)
 594                     ; 131   assert_param(IS_WFE_SOURCE(WFE_Source));
 596                     ; 133   switch (WFE_Source)
 599                     ; 216     default:
 599                     ; 217       break;
 ...
 673  013e               L122:
 674                     ; 135     case WFE_Source_TIM2_EV0:
 674                     ; 136     case WFE_Source_TIM2_EV1:
 674                     ; 137     case WFE_Source_TIM1_EV0:
 674                     ; 138     case WFE_Source_TIM1_EV1:
 674                     ; 139     case WFE_Source_EXTI_EV0:
 674                     ; 140     case WFE_Source_EXTI_EV1:
 674                     ; 141     case WFE_Source_EXTI_EV2:
 674                     ; 142     case WFE_Source_EXTI_EV3:
 674                     ; 143 
 674                     ; 144       if ((WFE->CR1 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 676  013e c650a6        	ld	a,20646
 677  0141 1503          	bcp	a,(OFST+2,sp)
 678  0143 2706          	jreq	L162
 679                     ; 147         status = ENABLE;
 681  0145 a601          	ld	a,#1
 682  0147 6b01          	ld	(OFST+0,sp),a
 685  0149 2035          	jra	L752
 686  014b               L162:
 687                     ; 152         status = DISABLE;
 689  014b 0f01          	clr	(OFST+0,sp)
 691  014d 2031          	jra	L752
 692  014f               L322:
 693                     ; 156     case WFE_Source_EXTI_EV4:
 693                     ; 157     case WFE_Source_EXTI_EV5:
 693                     ; 158     case WFE_Source_EXTI_EV6:
 693                     ; 159     case WFE_Source_EXTI_EV7:
 693                     ; 160     case WFE_Source_EXTI_EVB_G:
 693                     ; 161     case WFE_Source_EXTI_EVD_H:
 693                     ; 162     case WFE_Source_EXTI_EVE_F:
 693                     ; 163     case WFE_Source_ADC1_COMP_EV:
 693                     ; 164 
 693                     ; 165       if ((WFE->CR2 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 695  014f c650a7        	ld	a,20647
 696  0152 1503          	bcp	a,(OFST+2,sp)
 697  0154 2706          	jreq	L562
 698                     ; 168         status = ENABLE;
 700  0156 a601          	ld	a,#1
 701  0158 6b01          	ld	(OFST+0,sp),a
 704  015a 2024          	jra	L752
 705  015c               L562:
 706                     ; 173         status = DISABLE;
 708  015c 0f01          	clr	(OFST+0,sp)
 710  015e 2020          	jra	L752
 711  0160               L522:
 712                     ; 176     case WFE_Source_TIM3_EV0:
 712                     ; 177     case WFE_Source_TIM3_EV1:
 712                     ; 178     case WFE_Source_TIM4_EV:
 712                     ; 179     case WFE_Source_SPI1_EV:
 712                     ; 180     case WFE_Source_I2C1_EV:
 712                     ; 181     case WFE_Source_USART1_EV:
 712                     ; 182     case WFE_Source_DMA1CH01_EV:
 712                     ; 183     case WFE_Source_DMA1CH23_EV:
 712                     ; 184 
 712                     ; 185       if ((WFE->CR3 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 714  0160 c650a8        	ld	a,20648
 715  0163 1503          	bcp	a,(OFST+2,sp)
 716  0165 2706          	jreq	L172
 717                     ; 188         status = ENABLE;
 719  0167 a601          	ld	a,#1
 720  0169 6b01          	ld	(OFST+0,sp),a
 723  016b 2013          	jra	L752
 724  016d               L172:
 725                     ; 193         status = DISABLE;
 727  016d 0f01          	clr	(OFST+0,sp)
 729  016f 200f          	jra	L752
 730  0171               L722:
 731                     ; 197     case WFE_Source_TIM5_EV0:
 731                     ; 198     case WFE_Source_TIM5_EV1:
 731                     ; 199     case WFE_Source_AES_EV:
 731                     ; 200     case WFE_Source_SPI2_EV:
 731                     ; 201     case WFE_Source_USART2_EV:
 731                     ; 202     case WFE_Source_USART3_EV:
 731                     ; 203     case WFE_Source_RTC_CSS_EV:
 731                     ; 204 
 731                     ; 205       if ((WFE->CR4 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 733  0171 c650a9        	ld	a,20649
 734  0174 1503          	bcp	a,(OFST+2,sp)
 735  0176 2706          	jreq	L572
 736                     ; 208         status = ENABLE;
 738  0178 a601          	ld	a,#1
 739  017a 6b01          	ld	(OFST+0,sp),a
 742  017c 2002          	jra	L752
 743  017e               L572:
 744                     ; 213         status = DISABLE;
 746  017e 0f01          	clr	(OFST+0,sp)
 748  0180               L132:
 749                     ; 216     default:
 749                     ; 217       break;
 751  0180               L752:
 752                     ; 219   return status;
